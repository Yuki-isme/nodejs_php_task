...
const Bill = {
    fieldDefs: [
        {field: 'bill_id',           label: 'Bill ID',        type: 'varchar',  validate: {rules: [{rule: 'required', value: true, message: 'Please insert'}, {rule: 'remote', tables: ['bills', 'archives'], message: 'Bill ID already exists'}]},                                                          display: true, hidden: false, orderable: true, onlySelect: false, insert: true, quick_edit: true, relation: false},
